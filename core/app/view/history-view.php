...
<center>
	<h2>Entradas</h2>
	<h1><?php echo number_format(($itotal*$product->unit)/$product->description,0); ?></h1>
</center>
</div>
...
<center>
	<h2>Disponibles</h2>
	<h1><?php echo number_format(($total*$product->unit)/$product->description,0); ?></h1>
</center>
</div>
...
<center>
	<h2>Salidas</h2>
	<h1><?php echo number_format(($ototal*$product->unit)/$product->description,0); ?></h1>
</center>
</div>
...
<div class="row">
	<div class="col-md-12">
		<?php if(count($operations)>0):?>
			...
			<tr>
			<td></td>
			<td><?php echo number_format(($operation->q*$product->unit)/$product->description,0); ?></td>
