...
$total = 0;
?>
<h2>Lista de Cargues y Pedidos</h2>
<table class="table table-bordered table-hover">
    <thead>
...
?>
    <tr>
        ...
        <td style="width:30px;"><a href="index.php?view=clearcart&product_id=<?php echo $product->id; ?>"
                class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a></td>
    </tr>
...
$clients = PersonData::getClients();
    ...
    <div class="form-group" style="display:none">
        ...
        <div class="col-lg-10">
            <input type="text" name="discount" class="form-control" required value="0" id="discount"
        ...
        <div class="col-md-6 col-md-offset-6">
            ...
            <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                    <div class="checkbox">
                        <label>
                            <a href="index.php?view=clearcart" class="btn btn-lg btn-danger"><i
