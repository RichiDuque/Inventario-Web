    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="./" class="logo">
                ...
                <span class="logo-lg"><b>FRITO</b>LAY</span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="./?view=sell"><i class='fa fa-usd'></i><span>Cargue/Pedido</span></a></li>
                    <li><a href="./?view=vendedor"><i><img src="./storage/empleado.png" alt="" style="width:15px"></i>
                            <span>Vendedores</span></a></li>
                    <li><a href="./?view=box"><i class='fa fa-cube'></i> <span>Caja</span></a></li>
                    <li><a href="./?view=products"><i><img src="./storage/mekato.png" alt="" style="width:20px"></i>
                            <span>Productos</span></a></li>

                    <li class="treeview">
                        <a href="#"><i class='fa fa-database'></i> <span>Adicionar</span> <i
                                class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                            <li><a href="./?view=categories">Categorias</a></li>
                            <li><a href="./?view=clients">Vendedores</a></li>
                            <li><a href="./?view=providers">Proveedores</a></li>
                        </ul>
                    </li>

                    <li class="treeview">
                        <a href="#"><i class='fa fa-area-chart'></i> <span>Inventario</span> <i
                                class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                        <a href="#"><i class='fa fa-cog'></i> <span>Administracion</span> <i
                                class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
        ...
        <div class="login-box">
            <div class="login-logo">
                <a href="./">INVENTARIO<b>FRITO LAY</b></a>
            </div><!-- /.login-logo -->
